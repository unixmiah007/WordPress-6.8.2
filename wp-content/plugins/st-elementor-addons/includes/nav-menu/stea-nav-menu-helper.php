...
namespace STEA_Widget_Helper;

class STEA_Secondary_Menu_Helper extends \Walker_Nav_Menu
{
	// Start Level
	public function start_lvl(&$output, $depth = 0, $args = null) {
		$indent = str_repeat("\t", $depth);
		$classes = ['stea-dropdown stea-submenu-panel'];
	...
	public function start_el(&$output, $item, $depth = 0, $args = null, $id = 0) {
		...
		if ( in_array( 'menu-item-has-children', $classes ) ) {
			...
			if(!empty($args->submenu_indicator_icon)) {
				...
				$submenu_indicator .= '<i class="icon icon-down-arrow1 stea-submenu-indicator"></i>';
			}
		}
