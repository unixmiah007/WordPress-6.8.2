<?php
/**
 * Class STEA_Widget\STEA_Page_Checkout_Widget
 */
...
class STEA_Page_Checkout_Widget extends Widget_Base {

    /**
     * Get widget name.
     */
    public function get_name() {
        return 'stea_checkout';
    }
    ...
    public function get_title() {
        return __( 'ST Checkout', 'st-elementor-addons' );
    }
    ...
    protected function register_controls() {
		...
		$this->start_controls_section(
			'section_general',
			[
				'label' => esc_html__( 'Settings', 'st-elementor-addons' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'horizontal',
				'prefix_class' => 'stea-checkout-',
				'options' => [
					'vertical' => esc_html__( 'One Column', 'st-elementor-addons' ),
					'horizontal' => esc_html__( 'Two Columns', 'st-elementor-addons' ),
				],
				'label_block' => false,
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.stea-checkout-horizontal .stea-checkout-order-review-table' => 'width: {{SIZE}}{{UNIT}};',
					// '{{WRAPPER}}.stea-checkout-horizontal #customer_details' => 'width: {{SIZE}}{{UNIT}};',
					// '{{WRAPPER}}.stea-checkout-horizontal .stea-checkout-order-review-table' => 'width: calc(100% - {{SIZE}}{{UNIT}});',
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .stea-checkout-order-review-table-inner' => 'background-color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .stea-checkout-order-review-table-inner' => 'border-color: {{VALUE}}',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .stea-checkout-order-review-table-inner' => 'border-style: {{VALUE}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .stea-checkout-order-review-table-inner' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .stea-checkout-order-review-table-inner' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .stea-checkout-order-review-table-inner' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.stea-checkout-horizontal .woocommerce-checkout .col2-set' => 'margin-right: {{SIZE}}{{UNIT}};',
					'[data-elementor-device-mode="mobile"] {{WRAPPER}}.stea-checkout-horizontal .woocommerce-checkout .col2-set' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.stea-checkout-horizontal .col-1' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.stea-checkout-horizontal .stea-checkout-order-review-table-inner' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.stea-checkout-vertical .col-1' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.stea-checkout-vertical .col-2' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.stea-checkout-vertical .stea-checkout-order-review-table-inner' => 'margin-bottom: {{SIZE}}{{UNIT}};',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Titles', 'st-elementor-addons' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Inputs', 'st-elementor-addons' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'type' => Controls_Manager::SLIDER,
				'label' => esc_html__( 'Textarea Height', 'st-elementor-addons' ),
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Orders Table', 'st-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Table Heading', 'st-elementor-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Table Description', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Place Order', 'st-elementor-addons' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'  => esc_html__( 'Separator Color', 'st-elementor-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#E8E8E8',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Input', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Tooltips', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Order Received', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Order Overview Typography', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Coupon & Place Order Button', 'st-elementor-addons' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
	...
	public function woocommerce_checkout_before_customer_details() {
		echo '<div class="stea-customer-details-wrapper">';
	}
	
	public function woocommerce_checkout_before_order_review_heading() {
        echo '<div class="stea-checkout-order-review-table">';
        echo '<div class="stea-checkout-order-review-table-inner">';
	}
	...
	public function woocommerce_checkout_order_review() {
		echo '</div>';
		echo '</div>';
		echo '<div class="stea-checkout-order-review">';
	}
