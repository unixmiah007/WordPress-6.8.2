...
class STEA_Current_Date_Time extends Tag
{

	public function get_name()
	{
		return 'stea-current-date-time';
	}

	public function get_title()
	{
		return esc_html__('Current Date Time', 'st-elementor-addons' );
	}
	...
	protected function register_controls()
	{
		$this->add_control(
			'date_format',
			[
				'label' => esc_html__('Date Format', 'st-elementor-addons' ),
		...
		$this->add_control(
			'time_format',
			[
				'label' => esc_html__('Time Format', 'st-elementor-addons' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'default' => esc_html__('Default', 'st-elementor-addons' ),
					'' => esc_html__('None', 'st-elementor-addons' ),
