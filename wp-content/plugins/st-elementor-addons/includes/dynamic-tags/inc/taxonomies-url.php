...
class STEA_Taxonomies_Url extends Tag
{
	...
	{
		return esc_html__('Taxonomies URL', 'st-elementor-addons' );
	}
	...
	public function get_categories_list()
	{
		...
		$categories = St_Elementor_Addons_Helper::stea_post_types_category_slug();
	...
	protected function register_controls()
	{
		$this->add_control(
			'key',
			[
				'label'   => esc_html__('Categories URL', 'st-elementor-addons' ),
