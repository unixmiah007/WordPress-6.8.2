...
class STEA_Contact_URL extends Tag
{

	public function get_name()
	{
		return 'stea-contact-url';
	}

	public function get_title()
	{
		return esc_html__('Contact URL', 'st-elementor-addons' );
	}
	...
	protected function register_controls()
	{
		$this->add_control(
			...
			[
				...
				'options' => [
					'' => '— ' . esc_html__('Select', 'st-elementor-addons' ) . ' —',
					'email' => esc_html__('Email', 'st-elementor-addons' ),
					'tel' => esc_html__('Tel', 'st-elementor-addons' ),
					'sms' => esc_html__('SMS', 'st-elementor-addons' ),
					'whatsapp' => esc_html__('WhatsApp', 'st-elementor-addons' ),
					'skype' => esc_html__('Skype', 'st-elementor-addons' ),
					'messenger' => esc_html__('Messenger', 'st-elementor-addons' ),
					'viber' => esc_html__('Viber', 'st-elementor-addons' ),
					'waze' => esc_html__('Waze', 'st-elementor-addons' ),
					'google_calendar' => esc_html__('Google Calendar', 'st-elementor-addons' ),
					'outlook_calendar' => esc_html__('Outlook Calendar', 'st-elementor-addons' ),
					'yahoo_calendar' => esc_html__('Yahoo Calendar', 'st-elementor-addons' ),
				],
			]
		);
		...
		$this->add_control(
			'mail_to',
			[
				'label' => esc_html__('Email', 'st-elementor-addons' ),
		...
		$this->add_control(
			'mail_subject',
			[
				'label' => esc_html__('Subject', 'st-elementor-addons' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => 'true',
				'condition' => [
					'link_type' => 'email',
		...
		$this->add_control(
			'mail_body',
			[
				'label' => esc_html__('Message', 'st-elementor-addons' ),
		...
		$this->add_control(
			'tel_number',
			[
				'label' => esc_html__('Number', 'st-elementor-addons' ),
				'type' => Controls_Manager::TEXT,
				'condition' => [
					'link_type' => [
						'tel',
		...
		$this->add_control(
			'username',
			[
				'label' => esc_html__('Username', 'st-elementor-addons' ),
				'type' => Controls_Manager::TEXT,
				'condition' => [
		...
		$this->add_control(
			'viber_action',
			[
				'label' => esc_html__('Action', 'st-elementor-addons' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'contact' => esc_html__('Contact', 'st-elementor-addons' ),
					'add' => esc_html__('Add', 'st-elementor-addons' ),
				],
				'default' => 'contact',
				'condition' => [
					'link_type' => 'viber',
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'call' => esc_html__('Call', 'st-elementor-addons' ),
					'chat' => esc_html__('Chat', 'st-elementor-addons' ),
					'userinfo' => esc_html__('Show Profile', 'st-elementor-addons' ),
					'add' => esc_html__('Add to Contacts', 'st-elementor-addons' ),
					'voicemail' => esc_html__('Send Voice Mail', 'st-elementor-addons' ),
				],
				'default' => 'call',
				'condition' => [
					'link_type' => 'skype',
		...
		$this->add_control(
			'waze_address',
			[
				'label' => esc_html__('Location', 'st-elementor-addons' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => 'true',
				'condition' => [
					'link_type' => 'waze',
		...
		$this->add_control(
			'event_start_date',
			[
				'label' => esc_html__('Start', 'st-elementor-addons' ),
		...
		$this->add_control(
			'event_end_date',
			[
				'label' => esc_html__('End', 'st-elementor-addons' ),
				'type' => Controls_Manager::DATE_TIME,
				'condition' => [
					'link_type' => [
						'google_calendar',
