...
class STEA_Shortcode extends Tag
{
	public function get_name()
	{
		return 'stea-shortcode';
	}

	public function get_title()
	{
		return esc_html__('Shortcode', 'st-elementor-addons' );
	}
	...
	protected function register_controls()
	{
		$this->add_control(
			'shortcode',
			[
				'label' => esc_html__('Shortcode', 'st-elementor-addons' ),
	...
	public function render()
	{
		 ...
		 */
		$should_escape = apply_filters('stea/core_elements/dynamic_tags/shortcode/should_escape', true);
