...
class STEA_Request_Parameter extends Tag
{
	public function get_name()
	{
		return 'stea-request-parameter';
	}

	public function get_title()
	{
		return esc_html__('Request Parameter', 'st-elementor-addons' );
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			'param_name',
			[
				'label'   => esc_html__('Parameter Name', 'st-elementor-addons' ),
