<?php
/**
 * Class STEA_Widget\STEA_Page_Cart_Widget
 */
...
class STEA_Page_Cart_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __( 'ST Cart', 'st-elementor-addons' );
    }
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'label' => esc_html__( 'Cart Update', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Update Cart', 'st-elementor-addons' ),
				'default' => esc_html__( 'Update Cart', 'st-elementor-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Totals', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Cart Totals', 'st-elementor-addons' ),
				'default' => esc_html__( 'Cart Totals', 'st-elementor-addons' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .stea-cart-wrapper .cart-collaterals' => 'width: {{SIZE}}%;',
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Proceed to Checkout', 'st-elementor-addons' ),
				'default' => esc_html__( 'Proceed to Checkout', 'st-elementor-addons' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'prefix_class' => 'stea-checkout-flex-',
				'default' => 'end',
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Shipping Update', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Update', 'st-elementor-addons' ),
				'default' => esc_html__( 'Update', 'st-elementor-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Coupon', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => esc_html__( 'Apply coupon', 'st-elementor-addons' ),
				'default' => esc_html__( 'Apply coupon', 'st-elementor-addons' ),
			]
		);
		...
		$this->add_responsive_control(
			'coupon_input_width',
			[
				'label' => esc_html__( 'Input Width', 'st-elementor-addons' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'%' => [
						'min' => 0,
				...
				'selectors' => [
					...
					'{{WRAPPER}} .stea-cart-section-wrap .coupon-col-start' => 'width: {{SIZE}}{{UNIT}};',
				],
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			'coupon_input_gutter',
			[
				'label' => esc_html__( 'Gutter', 'st-elementor-addons' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Product Summary', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.stea-cart-horizontal .woocommerce-cart-form' => 'width: {{SIZE}}{{UNIT}};',
					// '{{WRAPPER}}.stea-cart-horizontal .cart-collaterals' => 'width: calc(100% - {{SIZE}}{{UNIT}});',
				],
				'condition' => [
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}}.stea-cart-horizontal .woocommerce-cart-form' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.stea-cart-vertical .woocommerce-cart-form' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					// '{{WRAPPER}} .stea-cart-section-wrap .shop_table.cart' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .stea-cart-section-table-wrap' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					'[data-elementor-device-mode="mobile"] {{WRAPPER}}.stea-cart-horizontal .cart-collaterals' => 'margin-top: {{SIZE}}{{UNIT}};',
					'[data-elementor-device-mode="mobile_extra"] {{WRAPPER}}.stea-cart-horizontal .cart-collaterals' => 'margin-top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .stea-cart-section-table-wrap' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} table td' => 'background-color: {{VALUE}}',
					'{{WRAPPER}} .stea-cart-section' => 'background-color: {{VALUE}}',
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .cart_totals, {{WRAPPER}} table.cart, {{WRAPPER}} .stea-cart-section',
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Wrappers', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .stea-cart-section' => 'border-style: {{VALUE}};',
					'{{WRAPPER}} .cart_totals' => 'border-style: {{VALUE}};',
					'{{WRAPPER}} .stea-cart-section-wrap table.shop_table td:not(:last-child)' => 'border-style: {{VALUE}};',
					'{{WRAPPER}} .stea-cart-section-wrap table.shop_table th' => 'border-style: {{VALUE}};',
					'{{WRAPPER}} .stea-cart-section-table-wrap' => 'border-style: {{VALUE}};'
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '#E8E8E8',
				'selectors' => [
					'{{WRAPPER}} .stea-cart-section' => 'border-color: {{VALUE}}',
					'{{WRAPPER}} .cart_totals' => 'border-color: {{VALUE}}',
					'{{WRAPPER}} .stea-cart-section-wrap table.shop_table' => 'border-color: {{VALUE}}',
					'{{WRAPPER}} .stea-cart-section-table-wrap' => 'border-color: {{VALUE}}'
				],
				'condition' => [
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .stea-cart-section' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .cart_totals' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .stea-cart-section-wrap table.shop_table' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .stea-cart-section-table-wrap' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
				'condition' => [
					'cart_wrappers_border_type!' => 'none',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .stea-cart-section' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .cart_totals' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .stea-cart-section-wrap table.shop_table' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .stea-cart-section-table-wrap' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Table Cells', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .stea-cart-section-table-wrap' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
					'{{WRAPPER}} .stea-cart-section' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator' => 'before'
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Table Heading', 'st-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Table Cell', 'st-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Product Title', 'st-elementor-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Product Image', 'st-elementor-addons' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Remove Icon', 'st-elementor-addons' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Box Size', 'st-elementor-addons' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Forms', 'st-elementor-addons' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Notice', 'st-elementor-addons' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			'notice_link_color',
			[
				'label' => esc_html__( 'Link Color', 'st-elementor-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#FFFFFF',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Link Hover Color', 'st-elementor-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#FFFFFF',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Success Color', 'st-elementor-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#FFFFFF',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Info Color', 'st-elementor-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#30B5FF',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Error Color', 'st-elementor-addons' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#FF19FD',
				'selectors' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Buttons', 'st-elementor-addons' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Cart Totals', 'st-elementor-addons' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'General Typography', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Headings', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Descriptions', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'type' => Controls_Manager::HEADING,
				'label' => esc_html__( 'Shipping Calculator', 'st-elementor-addons' ),
				'separator' => 'before'
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Change Address Padding', 'st-elementor-addons' ),
				'type' => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				'default' => [
					'top' => 6,
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Checkout Button', 'st-elementor-addons' ),
				'tab' => Controls_Manager::TAB_STYLE,
				'show_label' => false,
			]
		);
	...
	public function woocommerce_before_cart() {
		echo '<div class="stea-cart-wrapper">';
	}
	...
	public function woocommerce_before_cart_table() {
		echo '<div class="stea-cart-section-wrap">';
		echo '<div class="stea-cart-section-table-wrap">';
	}
	...
	public function render_woocommerce_cart_coupon_form() {
		...
		?>
			<div class="coupon stea-cart-section shop_table">
				<div class="form-row coupon-col">
					<div class="coupon-col-start">
						<input type="text" name="coupon_code" class="input-text" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Coupon code', 'st-elementor-addons' ); ?>" />
					</div>
					<div class="coupon-col-end">
						<button <?php $this->print_render_attribute_string( 'button_coupon' ); ?> value="<?php esc_attr_e( 'Apply coupon', 'st-elementor-addons' ); ?>"><?php esc_attr_e( 'Apply coupon', 'st-elementor-addons' ); ?></button>
					</div>
	...
	public function filter_gettext( $translation, $text, $domain ) {
		if ( 'woocommerce' !== $domain && 'st-elementor-addons' !== $domain ) {
			return $translation;
		}
