...
class Astra_Theme_Compatibility {
	...
	public function hooks() {
		...
		if ( stea_theme_builder_header_enabled() ) {
			...
			add_action( 'astra_header', 'stea_theme_builder_render_header' );
		}
		...
		if ( stea_theme_builder_footer_enabled() ) {
			...
			add_action( 'astra_footer', 'stea_theme_builder_render_footer' );
		}

		if ( stea_theme_builder_is_singular_enabled() ) {

			$this->override_with_post_meta( stea_theme_builder_get_singular_id() );
		...
		if ( stea_theme_builder_is_archive_enabled() ) {
			...
			$this->override_with_post_meta( stea_theme_builder_get_archive_id() );
