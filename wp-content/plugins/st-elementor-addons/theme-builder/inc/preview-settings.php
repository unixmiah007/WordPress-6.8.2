...
class Stea_Theme_Builder_Settings extends Elementor\Core\Base\Document {

	public function get_name() {
		return 'stea-theme-template';
	}
	...
	public static function get_title() {
		return __( 'Theme Builder', 'st-elementor-addons' );
	}

	public static function get_properties() {
		$properties = parent::get_properties();

		$properties['cpt']           = array( 'stea-theme-template' );
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_stea_preview_settings',
			array(
				'label' => __( 'Preview Settings', 'st-elementor-addons' ),
				'tab'   => Controls_Manager::TAB_SETTINGS,
			)
		);

		$default_archives = array(
			'archive/posts'            => __( 'Posts Archive', 'st-elementor-addons' ),
			'product_archive/products' => __( 'Products Archive', 'st-elementor-addons' ),
			'archive/author'           => __( 'Author Archive', 'st-elementor-addons' ),
			'archive/date'             => __( 'Date Archive', 'st-elementor-addons' ),
			'archive/search'           => __( 'Search Results', 'st-elementor-addons' ),
		);
		...
		$this->add_control(
			'preview_source',
			array(
				'label'   => __( 'Preview Source', 'st-elementor-addons' ),
				'type'    => Controls_Manager::SELECT,
				'default' => $query,
				'groups'  => array(
					''         => __( 'Select', 'st-elementor-addons' ),
					'single'   => array(
						'label'   => __( 'Singular', 'st-elementor-addons' ),
						'options' => $post_types,
					),
					'archive'  => array(
						'label'   => __( 'Archives', 'st-elementor-addons' ),
						'options' => $default_archives,
					),
					'taxonomy' => array(
						'label'   => __( 'Taxonomies', 'st-elementor-addons' ),
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Select Author', 'st-elementor-addons' ),
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Search Keyword', 'st-elementor-addons' ),
		...
		$this->add_control(
			...
			array(
				...
				'raw'       => '<div class="elementor-update-preview editor-stea-preview-update"><span>Update Preview</span><button class="elementor-button elementor-button-success"><i class="eicon eicon-spinner"></i>Apply</button>',
				'separator' => 'before',
			)
		);
	...
	public function switch_to_preview_query() {
		if ( 'stea-theme-template' === get_post_type( get_the_ID() ) ) {
