            ...
            <tr class="first last"> 
                <td class="a-right last" colspan="50">
                    ...
                    <button onclick="location.href = '<?php echo esc_url(get_permalink(wc_get_page_id('shop'))); ?>'"
                                    class="button btn-continue" title="<?php esc_attr_e('Continue Shopping', 'woocommerce'); ?>" type="button"><span><?php esc_attr_e('Continue Shopping', 'organ'); ?></span>
                    </button>   

                    <input type="submit" class="button btn-update" name="update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"/>

                    <button id="empty_cart_button" class="button" title="<?php esc_attr_e('Clear Cart', 'organ'); ?>" 
                                        name="clear-cart" type="submit"><span><?php esc_attr_e('Clear Cart', 'organ'); ?></span></button>                      
     ...
     <div class="cart-collaterals row">
           ...
           <div class="col-sm-6">
                ...
                <?php if ( wc_coupons_enabled() ) { ?>
                    ...
                    <h3><?php esc_attr_e('Discount Codes', 'organ'); ?></h3>
                      <div id="discount-coupon-form">
                        <label for="coupon_code"> <?php esc_attr_e('Enter your coupon code if you have one', 'organ'); ?>:</label> 
