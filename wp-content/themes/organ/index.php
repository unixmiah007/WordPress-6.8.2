...
<?php if(isset($organ_Options['theme_layout']) && $organ_Options['theme_layout']!='version2'){ ?>
  <div class="page-heading">
    ...
    <?php //if($TmOrgan->tmOrgan_page_title()!=''){ ?>
				...
				<?php 	while (have_posts()) : the_post(); ?>
							<article  id="post-<?php echo esc_html($post->ID); ?>" <?php post_class('blog-post container-paper'); ?>>								
								...
								<div class="post-container">
									...
									<ul class="list-info">
										<?php if (!isset($organ_Options) || $organ_Options['blog_show_post_by'] == 1 ) { ?>
											<li><i class="fa fa-user"></i><?php esc_attr_e('By', 'organ'); ?>  <?php the_author(); ?>	</li>
											<li class="divider">|</li>
										<?php } ?>
										<?php if(!isset($organ_Options) ||  $organ_Options['blog_display_category']==1) {  if(has_category()){
											...
											<li class="divider">|</li>
											 <?php } } ?>
												...
												<?php if (!isset($organ_Options) || $organ_Options['blog_display_view_counts'] == 1) { ?>
													<li><i class="fa fa-eye"></i><?php echo esc_html($TmOrgan->tmOrgan_getPostViews(get_the_ID())); ?> </li>
													<li class="divider">|</li>
												<?php } ?>
												<?php if (!isset($organ_Options) || $organ_Options['blog_display_comments_count'] == 1) { ?>
