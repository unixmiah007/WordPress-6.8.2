  ...
  <div class="container">
    ...
    <?php } ?>
      ...
      <div class="<?php echo esc_html($col); ?>">
        <div class="searchtitle"><h2><?php printf( esc_html__( 'Search Results for: %s', 'organ' ), esc_html( get_search_query())); ?>
...
['blog_display_category']==1) { if(has_category()){
                      ...
                      <li class="divider">|</li>
                       <?php } } ?>
                                       <?php if (!has_post_thumbnail() && (!isset($organ_Options) || $organ_Options['blog_show_post_by'] == 1 )) { ?>
